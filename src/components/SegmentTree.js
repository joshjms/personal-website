...
function SegmentTree() {
    ...
    return (
        <ParallaxBanner className="aspect-[2/1] h-screen relative bg-gray-50">
                ...
                <div className="absolute w-max h-max inset-0 top-[45%] left-[20%]">
                    <div className="mb-3">
                        ...
                        <p className="font-light">
                            Student @ NTU - Ex-Competitive Programmer
                        </p>
                    </div>
                </div>
            </ParallaxBannerLayer>
            <ParallaxBannerLayer translateX={[-180, 50]} easing={"easeOutQuad"}>
                <div className="absolute w-max h-max inset-0 top-[55%] left-[20%]">
                    <FlipCard>
                        <div className="bg-gradient-to-r from-violet-500 to-fuchsia-500 w-80 p-3 rounded-2xl hover:cursor-pointer">
